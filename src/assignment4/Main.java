...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String, Set<String>> followers = SocialNetwork.getFollowers2(tweetsList);
        System.out.println(followers);
        
        
        
        List<String> mostfollowed =  SocialNetwork.findKMostFollower(tweetsList, 10);
 ...
 * Do we have to change any of timespan
 * is it that easy to filter
 * exhaustive list for dates
 */
